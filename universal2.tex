...
\begin{enumerate}
    ...
    \begin{enumerate}[(a)]
        ...
        Next recover $\sigma_y(x'_y(p_i(v_2)))$ from $\sigma_y(P'_y(v_2))$ and $d_y(x'_y(p_i(v)))$.   The colour $\psi_y(p_i(v_2))$ is stored explicitly in the label of $(v_2,y_2)$ and $\psi_y(v_1)$ can be recovered from the label of $(v_1,y_1)$ since $\psi_y(v_1)=\psi_y(p_{\varphi(v_1)}(v_1))$.\todo{Double check}
